        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <img src="<?php echo base_url() ?>assets/uploads/services/<?php echo $service['icon_image']; ?>" alt="service-image" class="img-fluid">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="it-service-text">
                        <p> <b><?php echo $service['service_detail_name']; ?> </b> – <?php echo $service['description']; ?> 
                    </p>
                </div>
            </div>
        </div>
...
<?php } ?>
<?php
$exp_benefits = explode("</p>", $service['benefits']);
if (count($exp_benefits) > 0) {
    ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                    <img src="<?php echo base_url() ?>assets/images/lazyload-icon.gif" data-src="<?php echo base_url() ?>assets/uploads/services/<?php echo $service['benefits_image']; ?>" class="img-fluid lazyload" data-aos="fade-up" alt="app-development-benefits">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <ul class="serv-list">
                        <?php
                        foreach ($exp_benefits as $i => $value) {
                            if ($value != "") {
                                $j = ($i + 1) % 2;
                                ?>
